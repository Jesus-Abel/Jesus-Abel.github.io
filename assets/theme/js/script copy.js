...
(function() {
    ...
    l(function() {
        ...
        if (n) {
            ...
            var r = [];
            f(document).on("add.cards", function(a) {
                a.target !== document && !r.some(function(b) {
                    return b === a.target
                ...
                var a = function() {
                    ...
                    g.forEach(function(k) {
                        var g = k.offsetHeight
                          , d = e(k);
                        (d + g >= a && d - 50 <= c || b(k)) && k.classList.contains("hidden") && (k.classList.remove("hidden"),
            ...
            var a = function(a) {
              ...
              , b = function(b) {
                ...
                l.addEventListener("click", function(b) {
                    ...
                    -1 !== e.indexOf("vimeo") && d.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(),
    ...
    if (!n) {
        ...
        !w() && (u = document.querySelector("section.menu")) && (z = window.innerWidth,
        !u.querySelector(".navbar").classList.contains("collapsed") && 991 < z && (u.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
    ...
    document.body.querySelectorAll(".clients").forEach(function(a) {
        a.getAttribute("data-isinit") || (x(a),
        G(a))
    })),
